...
function Section({ id, emoji, title, unit, children, open, onToggle }: {
  id: string; emoji: string; title: string; unit: string;
...
export default function GrammarTab() {
  ...
  return (
    <div className="space-y-3">
      ...
      {/* have got */}
      <Section id="havegot" emoji="🤝" title="have got — иметь" unit="Вводный раздел" open={o("havegot")} onToggle={() => toggle("havegot")}>
        <Table2
      ...
      {/* Артикли */}
      <Section id="articles" emoji="📰" title="Артикли a / an / the" unit="Вводный раздел" open={o("articles")} onToggle={() => toggle("articles")}>
        <div className="space-y-3">
          {[
            ...
            { pill: "the",    ru: "определённый — предмет уже известен или единственный",
              rows: [["the cat is black", "та самая кошка черная"], ["the sun", "солнце (одно)"]] },
      ...
      {/* Местоимения */}
      <Section id="pronouns" emoji="🔤" title="Местоимения" unit="Разделы 1–2" open={o("pronouns")} onToggle={() => toggle("pronouns")}>
        <div className="overflow-x-auto">
      ...
      {/* have to */}
      <Section id="haveto" emoji="📋" title="have to — должен, нужно" unit="Раздел 2" open={o("haveto")} onToggle={() => toggle("haveto")}>
        <Table2
      ...
      <Section id="tenses" emoji="⏱️" title="Present Simple vs Continuous" unit="Разделы 1, 3" open={o("tenses")} onToggle={() => toggle("tenses")}>
      ...
      {/* there is / there are */}
      <Section id="thereis" emoji="📦" title="there is / there are + some / any" unit="Раздел 4" open={o("thereis")} onToggle={() => toggle("thereis")}>
        <div className="space-y-3">
          <div>
      ...
      {/* how much / how many */}
      <Section id="quantity" emoji="🔢" title="how much / how many + количество" unit="Раздел 4" open={o("quantity")} onToggle={() => toggle("quantity")}>
        <div className="space-y-3">
          <Table2
      ...
      <Section id="adjprep" emoji="🔗" title="Прилагательное + предлог" unit="Раздел 4" open={o("adjprep")} onToggle={() => toggle("adjprep")}>
        <div className="space-y-3">
          {ADJ_PREP.map((r) => (
      ...
      {/* Модальные глаголы */}
      <Section id="modals" emoji="💬" title="Модальные глаголы" unit="Раздел 6" open={o("modals")} onToggle={() => toggle("modals")}>
        {MODALS.map((m) => (
          <div key={m.title}>
      ...
      {/* want to / need to */}
      <Section id="wantneed" emoji="🎯" title="want to / need to" unit="Раздел 5" open={o("wantneed")} onToggle={() => toggle("wantneed")}>
      ...
      {/* like / love / hate */}
      <Section id="likehate" emoji="❤️" title="like / love / hate + doing" unit="Раздел 5" open={o("likehate")} onToggle={() => toggle("likehate")}>
      ...
      {/* Предлоги места */}
      <Section id="prepositions" emoji="📍" title="Предлоги места" unit="Разделы 4–5" open={o("prepositions")} onToggle={() => toggle("prepositions")}>
        <div className="space-y-3">
          {PREPOSITIONS.map((p) => (
